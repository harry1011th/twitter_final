...
while True:
    user = api.get_user('Hardik43160834')
    api.update_profile(name=f'hardik|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : hardik|{follower_count(user)} Followers')
